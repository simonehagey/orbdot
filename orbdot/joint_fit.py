...
class JointFit:
    ...
    def ttv_rv_tdv_loglike_constant(self, theta):
        ...
        """
        return self.ttv_loglike_constant(theta) \
    ...
    def ttv_rv_tdv_loglike_decay(self, theta):
        ...
        """
        return self.ttv_loglike_decay(theta) \
    ...
    def ttv_rv_tdv_loglike_precession(self, theta):
        ...
        """
        return self.ttv_loglike_precession(theta) \
    ...
    def run_joint_fit(self, free_params, TTV=False, RV=False, TDV=False, model='constant',
                      file_suffix='', make_plot=True, sigma_clip=False, clip_model='linear'):
        ...
        if TTV and RV and not TDV:
            res = self.run_ttv_rv_fit(free_params, model, file_suffix, make_plot,
                                      sigma_clip, clip_model, save=True)

        elif TTV and TDV and not RV:
            res = self.run_ttv_tdv_fit(free_params, model, file_suffix, make_plot,
                                       sigma_clip, clip_model, save=True)
            ...
            res = self.run_ttv_rv_tdv_fit(free_params, model, file_suffix, make_plot,
                                          sigma_clip, clip_model, save=True)

        else:
            raise ValueError('The joint model fit cannot be run without specifying at least two '
    ...
    def run_ttv_rv_fit(self, free_params, model, suffix, plot, clip, clip_method, save):
        ...
        if clip:
            ...
            cleaned_filename = self.joint_save_dir + 'mid_times_cleaned' + suffix + '.txt'
            clipped_filename = self.joint_save_dir + 'mid_times_clipped' + suffix + '.txt'
        ...
        if save:
            print('-' * 100)
            print('Running joint TTV/RV {} fit with free parameters: {}'.format(model, free_params))
            print('-' * 100)
        ...
        if save:
            ...
            self.save_results(random_samples, samples, res, free_params,
                              self.joint_sampler, suffix, self.joint_save_dir + prefix,
                              illegal_params)
    ...
    def run_ttv_rv_tdv_fit(self, free_params, model, suffix, plot, clip, clip_method, save):
        ...
        if save:
            print('-' * 100)
            print('Running joint TTV/RV/TDV {} fit with free parameters: {}'.format(model,
                                                                                    free_params))
            print('-' * 100)
    ...
    def run_ttv_tdv_fit(self, free_params, model, suffix, plot, clip, clip_method, save):
        ...
        if save:
            print('-' * 100)
            print(
                'Running joint TTV/TDV {} fit with free parameters: {}'.format(model, free_params))
            print('-' * 100)
    ...
    def run_rv_tdv_fit(self, free_params, model, suffix, plot):
        ...
        print('-' * 100)
        print('Running joint RV/TDV {} fit with free parameters: {}'.format(model, free_params))
        print('-' * 100)
        ...
        self.save_results(random_samples, samples, res, free_params,
                          self.joint_sampler, suffix, self.joint_save_dir + prefix, illegal_params)
